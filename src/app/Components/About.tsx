...
export default function About() {
    return (
        <section id='About' className="my-12 px-8">
            <TitleText title='About Me' textStyle='text-center' />
            <div className='w-full min-h-[30vh] md:min-h-[50vh] mt-4 lg:mt-10 flex flex-col md:flex-row justify-between items-start gap-6'>
