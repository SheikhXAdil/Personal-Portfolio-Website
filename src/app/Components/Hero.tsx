        ...
        <section id='Home'>
            <div className='mt-12 lg:mt-20 flex flex-col lg:flex-row justify-evenly lg:justify-between'>
                <div className='md:basis-2/3 my-auto'>
                    ...
                    <div className='px-8'>
                        <h2 className='text-base sm:text-lg md:text-3xl font-bold'>And I&apos;m a <TypingText title='Full Stack NextJs Developer' textStyle='text-[#EC994B]' /></h2>
                ...
                <div className='lg:pl-0 mt-8 mx-auto basis-1/3'>
                    <div className=' bg-[#292750] w-[170px] h-[170px] sm:w-[200px] sm:h-[200px] md:w-[300px] md:h-[300px] rounded-full overflow-hidden mt-8 shadow-[#ec994b] shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(236,153,75,0.15)] '>
